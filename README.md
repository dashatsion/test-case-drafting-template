...
This skill helps QA engineers generate consistent, product-aware test cases using specs, docs, PRs, code context, browser observations, and existing test management context.
...
- support spec-based, code-based, browser-verified, or hybrid test case generation;
- keep reusable QA rules and context in one place.
...
Request review from the relevant maintainer or QA owner.
